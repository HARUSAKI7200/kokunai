...
class _EditFormPageState extends State<EditFormPage> {
    ...
    return Column(
      children: [
        FractionallySizedBox(
          ...
          child: InkWell(
            onTap: () =>
                _navigateToDrawingPage(imageBytes, onSave, imagePath),
            child: Container(
  ...
  void _navigateToDrawingPage(Uint8List? currentImage,
      Function(Uint8List?) onSave, String bgImagePath) async {
