...
class ComponentSpec {
  ...
  factory ComponentSpec.fromJson(Map<String, dynamic> j) => ComponentSpec(
        ...
        yobisun: j['yobisun'] != null &&
                j['yobisun'] < Yobisun.values.length
            ? Yobisun.values[(j['yobisun'] as num).toInt()]
            : null,
      );
}
...
class FormRecord {
  ...
  FormRecord copyWith({
    ...
    return FormRecord(
      ...
      yokoshitaDrawingImage:
          yokoshitaDrawingImage ?? this.yokoshitaDrawingImage,
  ...
  Map<String, dynamic> toJson() => {
        ...
        'subzaiDrawingImage': subzaiDrawingImage != null
            ? base64Encode(subzaiDrawingImage!)
            : null,
        'yokoshitaDrawingImage': yokoshitaDrawingImage != null
            ? base64Encode(yokoshitaDrawingImage!)
            : null,
        'hiraichiDrawingImage': hiraichiDrawingImage != null
            ? base64Encode(hiraichiDrawingImage!)
            : null,
        'remarks': remarks,
  ...
  factory FormRecord.fromJson(Map<String, dynamic> j) => FormRecord(
        ...
        materialType:
            ProductMaterialType.values[(j['materialType'] as num).toInt()],
        ...
        fukazai1:
            ComponentSpec.fromJson(j['fukazai1'] as Map<String, dynamic>),
        fukazai2:
            ComponentSpec.fromJson(j['fukazai2'] as Map<String, dynamic>),
        getaOrSuriSpec: ComponentSpec.fromJson(
            j['getaOrSuriSpec'] as Map<String, dynamic>),
        ...
        subzaiDrawingImage: j['subzaiDrawingImage'] != null
            ? base64Decode(j['subzaiDrawingImage'] as String)
            : null,
        yokoshitaDrawingImage: j['yokoshitaDrawingImage'] != null
            ? base64Decode(j['yokoshitaDrawingImage'] as String)
            : null,
        hiraichiDrawingImage: j['hiraichiDrawingImage'] != null
            ? base64Decode(j['hiraichiDrawingImage'] as String)
            : null,
